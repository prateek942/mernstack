  ...
  return (
    <div className='nav_container'>
        ...
        <div className='nav_list'>
            ...
            <div>
                <a href="https://github.com/prateek942" target='_blank' style={{color:'inherit'}}><AiFillGithub size="3rem"/></a>
                <a href="http://www.linkedin.com/in/prateek-kumar-pandey-4aaa21205/" target='_blank' style={{color:'inherit'}}><AiFillLinkedin size="3rem"/></a>
            </div>
        </div>
    </div>
  )
